        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceLogs_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerBalances_Payments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "Payments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerBalances_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Oda kiralamaya hazır", "Müsait" },
                    { 2, "Oda rezerve edilmiş", "Rezerve" },
                    { 3, "Oda bakımda", "Bakımda" },
                    { 4, "Oda arızalı", "Arızalı" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerBalances_PaymentId",
                table: "CustomerBalances",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerBalances_ReservationId",
                table: "CustomerBalances",
                column: "ReservationId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceLogs_RoomId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomStatuses_StatusName",
                table: "RoomStatuses",
                column: "StatusName",
                unique: true);
        }
